...
final filteredBikesProvider = Provider<List<Map<String, dynamic>>>((ref) {
            ...
            data: (snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return BikeCard(bikeData: filteredBikes[index]);
                },
              );
            },
...
class BikeCard extends StatelessWidget {
  ...
  const BikeCard({super.key, required this.bikeData});
